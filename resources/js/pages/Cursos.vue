            ...
            <main :class="['flex-1 pb-20', !isDashboard ? 'pt-28 md:pt-28' : 'pt-0']">
                ...
                >
                    <button 
                        v-if="showScrollTop"
                        @click="scrollToTop"
                        class="fixed bottom-6 right-6 z-40 p-4 rounded-full bg-primary text-on-primary shadow-2xl hover:bg-primary/95 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center border border-white/10"
