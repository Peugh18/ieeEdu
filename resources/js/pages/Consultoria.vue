    ...
    <component :is="isDashboard ? AppLayout : 'div'" v-bind="isDashboard ? { breadcrumbs } : {}">
        <div :class="['min-h-screen font-sans', !isDashboard ? 'bg-surface text-on-surface' : 'bg-transparent']">
            ...
            <main :class="[!isDashboard ? 'pt-20' : 'pt-0']">
                ...
                <!-- Hero Banner: Tarjeta Contenida Premium (Dashboard only) -->
                <div v-if="isDashboard" class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mb-10">
                    <div
                        class="relative overflow-hidden shadow-2xl rounded-[1.5rem]"
                    ...
                    >
                        ...
                        <div class="relative z-10 h-full px-10 md:px-14 flex flex-col justify-center">
