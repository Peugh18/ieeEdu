                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 relative items-start">
                    ...
                    <div class="lg:col-span-8 space-y-12">
                        ...
                        <div>
                            ...
                            <span class="inline-flex rounded-sm bg-surface-container-highest text-primary px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.1em] mb-6">
                                {{ getModalityLabel(course.type) }}
                            </span>
                            
                            <!-- Headline: Noto Serif -->
                            <h1 class="text-4xl sm:text-5xl lg:text-[56px] font-serif font-bold text-on-background leading-[1.1] mb-8 tracking-[-0.02em]">
                                {{ course.title }}
                            </h1>
                            ...
                            <div class="flex flex-wrap items-center gap-6 mb-8 pt-4 pb-8 bg-surface-container-highest p-6 rounded border-l-4 border-primary">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-bold text-sm text-on-background uppercase tracking-[0.05em]">{{ course.instructor_name || course.teacher?.name || 'Instructor Invitado' }}</p>
                                        <p class="text-[13px] text-on-surface-variant truncate max-w-[200px]">Docente especialista IEE</p>
                                    </div>
                                </div>
                                <div class="hidden sm:block w-[1px] h-8 bg-outline-variant"></div>
                                <div class="flex items-center gap-3">
                                    <div class="flex text-primary space-x-1">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                        <span class="font-bold text-base text-on-background ml-1">4.8</span>
                                    </div>
                                    <span class="text-[13px] text-on-surface-variant">(120 valoraciones)</span>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <template v-if="course.type === 'grabado'">
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Acceso Ilimitado</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Estudia a tu propio ritmo, 24/7 sin restricciones.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Material Descargable</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Recursos, plantillas y lecturas especializadas.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Certificado Digital</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Acreditación válida expedida por el IEE.</p>
                                </div>
                            </template>
                            ...
                            <template v-else-if="course.type === 'en vivo'">
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Clases en Vivo</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Interacción directa con el docente especialista.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    ...
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Asesoría Docente</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Resolución de casos y consultas en tiempo real.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Comunidad Activa</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Networking exclusivo con otros profesionales.</p>
                                </div>
                            </template>
                            ...
                            <template v-else>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    ...
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Sesión Magistral</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Análisis de alto nivel en un encuentro único.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Acceso Directo</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Preguntas y respuestas con el experto.</p>
                                </div>
                                <div class="bg-white p-6 rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-center flex flex-col items-center">
                                    <svg class="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                                    <h4 class="font-bold text-on-background mb-2 text-sm uppercase tracking-[0.05em]">Grupo WhatsApp</h4>
                                    <p class="text-[13px] text-on-surface-variant leading-relaxed">Avisos y recordatorios directamente en tu móvil.</p>
                                </div>
                            </template>
                        ...
                        <div class="mt-16 mb-16 bg-background rounded-3xl p-10 sm:p-14 border border-outline-variant/40 shadow-sm relative overflow-hidden group flex flex-col items-center text-center">
                            ...
                            <div class="relative z-10 max-w-2xl mx-auto">
                                ...
                                <h2 class="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-on-background mb-4">{{ course.instructor_name || course.teacher?.name || 'Instructor Invitado' }}</h2>
                                
                                <p v-if="course.instructor_title" class="text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-on-surface-variant border-t border-b border-outline-variant/40 py-3 mb-6 inline-block">
                                    {{ course.instructor_title }}
                                </p>
                                <p v-else class="text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-on-surface-variant border-t border-b border-outline-variant/40 py-3 mb-6 inline-block">
                                    Profesional Asociado al Instituto IEE
                                </p>
                                
                                <p v-if="course.instructor_bio" class="text-[16px] sm:text-[18px] text-on-surface-variant leading-relaxed font-serif max-w-2xl whitespace-pre-line text-center mx-auto">
                                    {{ course.instructor_bio }}
                                </p>
                                <p v-else class="text-[16px] sm:text-[18px] text-on-surface-variant leading-relaxed font-serif italic max-w-2xl text-center mx-auto">
                        ...
                        <div v-if="course.objectives" class="mb-16">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div v-for="(obj, i) in (course.objectives || '').split('\n').filter(o => o.trim())" :key="'obj-'+i" class="flex items-start gap-4 p-6 bg-white rounded shadow-[0_20px_40px_rgba(26,28,25,0.03)] border border-outline-variant/20">
                                    <div class="min-w-10 h-10 rounded-full bg-background flex items-center justify-center text-primary">
                        ...
                        <div v-if="course.requirements" class="mb-16">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div v-for="(req, i) in (course.requirements || '').split('\n').filter(r => r.trim())" :key="'req-'+i" class="flex items-start gap-4 p-6 bg-white rounded shadow-[0_20px_40px_rgba(26,28,25,0.03)] border border-outline-variant/20">
                                    <div class="min-w-10 h-10 rounded-full bg-background flex items-center justify-center text-primary">
                        ...
                        <div class="pt-10 mb-8">
                            <h2 class="text-[32px] font-serif font-bold text-on-background mb-10">{{ course.type === 'evento' ? 'Detalles del Evento' : (course.type === 'en vivo' ? 'Programa de Sesiones' : 'Estructura Curricular') }}</h2>
                            ...
                            <div v-if="(course.type === 'grabado' || course.type === 'en vivo') && course.modules?.length" class="space-y-6">
                                ...
                                <div v-for="(module, index) in course.modules" :key="module.id" class="bg-white rounded shadow-[0_20px_40px_rgba(26,28,25,0.03)] overflow-hidden">
                                    <button 
                                        ...
                                        class="w-full flex items-center justify-between p-6 bg-transparent hover:bg-background transition-colors"
                                    >
                                        ...
                                        <svg class="w-5 h-5 text-on-surface-variant transition-transform" :class="{'rotate-180': openModules.includes(module.id)}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                    </button>
                            ...
                            <div v-else-if="course.type === 'evento' && course.lessons?.length" class="space-y-6">
                                <div v-for="lesson in course.lessons" :key="lesson.id" class="bg-white rounded p-8 shadow-[0_20px_40px_rgba(26,28,25,0.04)] flex flex-col sm:flex-row gap-6 sm:items-center">
                                    ...
                                    <div class="flex-shrink-0 mt-4 sm:mt-0">
                                        <button class="px-5 py-3 rounded border border-outline-variant text-[11px] font-bold tracking-[0.05em] uppercase text-on-background hover:bg-surface-container-highest transition-colors">
                                            Agendar
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div v-else class="font-serif italic text-on-surface-variant py-16 text-center bg-white rounded shadow-[0_20px_40px_rgba(26,28,25,0.04)] text-lg">
                    ...
                    <div class="lg:col-span-4 lg:sticky lg:top-12 mt-8 lg:mt-0">
                        <div class="bg-white rounded p-8 shadow-[0_20px_40px_rgba(26,28,25,0.06)] backdrop-blur-3xl relative overflow-hidden">
                            ...
                            <button v-else @click="handleAddToCart" class="w-full bg-gradient-to-br from-primary to-[#707040] text-white font-bold text-[12px] uppercase tracking-[0.05em] py-4 rounded shadow-md hover:shadow-lg transition-all mb-4 flex items-center justify-center gap-3 hover:-translate-y-0.5">
                                Añadir al Carrito
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                            </button>

                            <p v-if="course.type === 'evento'" class="text-[11px] text-on-surface-variant mb-10 font-medium text-center tracking-wide">Al unirte al grupo tendrás todos los detalles e información para conectarte.</p>
                            <p v-else class="text-[11px] text-on-surface-variant mb-10 font-medium text-center italic tracking-wide">Transacción segura y acceso inmediato al campus institucional.</p>
                            ...
                            <div class="space-y-4 pt-6 border-t border-surface-container-highest">
                                ...
                                <ul class="text-[13px] text-on-surface-variant space-y-3 font-sans leading-relaxed">
                                    <li class="flex items-start gap-3">
                                        <div class="min-w-1.5 h-1.5 rounded-full bg-primary mt-1.5"></div>
