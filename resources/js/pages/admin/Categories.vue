    ...
    <AppLayout>
        <div class="max-w-7xl mx-auto px-4 py-8 space-y-10">
            ...
            <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                ...
                <button
                    @click="openCreate"
                    class="h-14 inline-flex items-center justify-center gap-3 rounded-2xl bg-primary px-8 text-sm font-bold text-white shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all"
                >
                    <Plus class="h-5 w-5" />
                    Nueva Categoría
                </button>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="group relative overflow-hidden rounded-[2rem] bg-white p-6 border border-slate-100 shadow-sm transition-all duration-300 hover:shadow-md hover:border-slate-200">
                    <div class="relative z-10 flex flex-col justify-between h-full space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <Layers class="h-4 w-4 text-primary/40" />
                        </div>
                        <div>
                ...
                <div class="group relative overflow-hidden rounded-[2rem] bg-primary p-6 shadow-xl shadow-primary/10 transition-all duration-300 hover:scale-[1.01]">
                    <div class="relative z-10 flex flex-col justify-between h-full space-y-4">
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-extrabold uppercase tracking-widest text-outline-variant">Actividad</span>
                            <Activity class="h-4 w-4 text-white/40" />
                        </div>
                        <div>
                            <p class="text-[10px] font-bold text-outline-variant uppercase tracking-widest leading-none">Estado de Red</p>
                ...
                <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm" @click.self="showModal = false">
                    <div class="w-full max-w-md rounded-[2.5rem] bg-white shadow-2xl overflow-hidden flex flex-col transition-all">
                        ...
                        <form @submit.prevent="submit" class="p-8 space-y-6">
                            ...
                            <div v-if="!editingCategory" class="rounded-2xl bg-primary/5 p-5 border border-primary/10 flex gap-3">
