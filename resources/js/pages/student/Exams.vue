                ...
                <div class="lg:col-span-2 space-y-6 flex flex-col">
                    ...
                    <div v-if="exams.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="exam in exams" :key="exam.id" 
                            class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden"
                        >
                            ...
                            <p class="text-xs text-[#57572A] font-bold uppercase tracking-wider mb-6">{{ exam.course_title }}</p>
                    ...
                    <div class="bg-[#57572A] rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
                        <div class="relative z-10">
                            ...
                            <div class="flex items-baseline gap-2 mb-2">
                                <span class="text-5xl font-serif font-bold">18.5</span>
                                <span class="text-lg text-white/60 font-serif">/ 20</span>
                            </div>
                            ...
                            <div class="flex items-center gap-3 p-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-bold">03 Certificaciones</p>
                                </div>
                            </div>
                        </div>
