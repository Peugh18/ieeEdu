    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="min-h-[calc(100svh-4rem)] bg-background text-on-background flex flex-col items-center">
            ...
            <div class="w-full max-w-7xl mx-auto p-5 md:p-12 flex flex-col gap-6 md:gap-10">
                ...
                <div class="lg:hidden space-y-4 pb-28">
                    <div v-if="live_classes.length === 0" class="py-20 flex flex-col items-center text-center bg-white rounded-3xl border border-dashed border-outline-variant/40">
                    ...
                    <template v-else>
                        ...
                        <div
                            ...
                            :key="session.id"
                            class="bg-white rounded-2xl border shadow-sm relative overflow-hidden active:scale-[0.98] transition-all"
                            :class="session.is_today ? 'border-[#D4AF37]/40 shadow-[#D4AF37]/10 shadow-lg' : 'border-outline-variant/20'"
                        >
                            <!-- Today badge -->
                            <div v-if="session.is_today" class="flex items-center gap-2 bg-[#D4AF37] text-white text-[10px] font-black px-4 py-2 uppercase tracking-[0.2em]">
                            ...
                            <div class="p-4">
                                <div class="flex items-center gap-4">
                                    <!-- Date Box -->
                                    <div
                                        class="flex flex-col items-center justify-center w-14 h-14 rounded-2xl border shadow-inner flex-shrink-0"
                                        :class="session.is_today ? 'bg-[#D4AF37]/5 border-[#D4AF37]/20' : 'bg-background border-outline-variant/20'"
                                    >
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-1.5 mt-1">
                                            <div class="w-1.5 h-1.5 rounded-full flex-shrink-0" :class="getCourseColor(session.course_id)"></div>
                                            <p class="text-[9px] text-on-surface-variant/60 font-black uppercase tracking-[0.15em] truncate">{{ session.course_title }}</p>
                                        </div>
                                        <div class="flex items-center gap-1.5 mt-1 text-[10px] font-bold text-on-surface-variant/50">
                                ...
                                <div class="mt-3 flex gap-2">
                                    <button
                                        ...
                                        class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] bg-background border border-outline-variant/20 text-primary active:scale-95 transition-all"
                                    >
                                    ...
                                    <button
                                        ...
                                        class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] bg-[#D4AF37] text-white shadow-lg active:scale-95 transition-all"
                                    >
