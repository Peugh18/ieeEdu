                ...
                >
                    <div class="relative aspect-[16/11] bg-gray-50 flex items-center justify-center p-4">
                        <div class="absolute inset-0 bg-gradient-to-t from-gray-900/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center gap-3 z-10">
                            <button class="p-3 bg-white text-gray-900 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all"><Eye class="w-5 h-5" /></button>
                            <button class="p-3 bg-[#57572A] text-white rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all outline outline-white/20"><Download class="w-5 h-5" /></button>
                            <button class="p-3 bg-[#D4AF37] text-white rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all outline outline-white/20"><Share2 class="w-5 h-5" /></button>
                        </div>
                    ...
                    <div class="p-6 flex flex-col flex-1">
                        ...
                        <div class="mt-auto space-y-4">
                            ...
                            <div class="flex gap-2">
                                <button class="flex-1 py-2.5 rounded-xl bg-gray-50 text-gray-600 text-[11px] font-bold uppercase tracking-widest hover:bg-gray-100 transition-colors flex items-center justify-center gap-2">
                                    <Printer class="w-4 h-4" /> Imprimir
                                </button>
                                <button class="flex-1 py-2.5 rounded-xl bg-[#57572A] text-white text-[11px] font-bold uppercase tracking-widest hover:bg-[#4a4a24] transition-colors flex items-center justify-center gap-2">
