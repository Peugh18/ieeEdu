...
<template>
    <div>
        ...
        >
            ...
            <div class="space-y-1">
                <h3 class="font-serif text-lg font-bold text-on-surface">Sin análisis estratégico</h3>
                <p class="max-w-xs text-xs text-on-surface-variant">No hemos encontrado ningún artículo o medio que coincida con la búsqueda.</p>
            </div>
        </div>
