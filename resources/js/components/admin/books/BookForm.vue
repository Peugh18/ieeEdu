...
<template>
    ...
    <template v-if="form.category !== 'Libro en camino'">
        ...
        <div class="bg-surface-dim p-8 rounded-[2rem] space-y-6 border border-primary/10">
            ...
            <div v-if="!isFree" class="space-y-4 pt-2 animate-in fade-in slide-in-from-top-4 duration-500">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <input v-model.number="form.stock" type="number" min="0" step="1" class="w-full rounded-2xl border border-outline-variant/20 bg-white px-5 py-3.5 text-sm font-black tabular-nums focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all" placeholder="Ej: 50">
                        <p class="text-[10px] text-on-surface-variant/60 italic">Unidades disponibles para venta.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
