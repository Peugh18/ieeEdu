...
<template>
    ...
    >
        <div v-if="showSuccess" class="fixed bottom-6 right-6 z-50 rounded-xl bg-[#4B5320] px-6 py-4 shadow-xl border border-white/20 flex items-center gap-3 text-white">
        ...
        <div v-else-if="showPublishSuccess" class="fixed bottom-6 right-6 z-50 rounded-xl bg-emerald-700 px-6 py-4 shadow-xl border border-white/20 flex items-center gap-3 text-white">
        ...
        <div v-else-if="showError" class="fixed bottom-6 right-6 z-50 rounded-xl bg-red-600 px-6 py-4 shadow-xl border border-white/20 flex items-center gap-3 text-white">
