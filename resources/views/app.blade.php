...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="/images/empresa/IcoLogo.ico" />
        <link rel="shortcut icon" type="image/x-icon" href="/images/empresa/IcoLogo.ico" />

        <link rel="preconnect" href="https://fonts.bunny.net">
        <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />
        
        <!-- Typography and Icons for Public Frontend -->
